  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText}`}>Hi, I'm <span className='text-[#915eef] '>Taufique</span></h1>
          <p className={`${styles.heroSubText}`}>I develop cross platform user friendly <br className='sm:block hidden'/>Mobile application and Websites</p>
        </div>
      </div>
          <ComputersCanvas/>
